...
public class MessageList
    ...
    public Dialog onCreateDialog(int id) {
		...
		} else if (id == R.id.dialog_confirm_spam) {
			return ConfirmationDialog.create(this, id,
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (itemId == R.id.compose) {
			...
			return true;
		} else if (itemId == R.id.select_all || itemId == R.id.batch_select_all) {
			setAllSelected(true);
			toggleBatchButtons();
			return true;
		} else if (itemId == R.id.batch_deselect_all) {
			setAllSelected(false);
			toggleBatchButtons();
			return true;
		} else if (itemId == R.id.batch_delete_op) {
			onDelete(selection);
			return true;
		} else if (itemId == R.id.batch_mark_read_op) {
			setFlag(selection, Flag.SEEN, true);
			return true;
		} else if (itemId == R.id.batch_mark_unread_op) {
			setFlag(selection, Flag.SEEN, false);
			return true;
		} else if (itemId == R.id.batch_flag_op) {
			setFlag(selection, Flag.FLAGGED, true);
			return true;
		} else if (itemId == R.id.batch_unflag_op) {
        ...
        if (itemId == R.id.check_mail) {
			...
			onEditAccount();
			return true;
		} else if (itemId == R.id.batch_copy_op) {
			onCopy(selection);
			return true;
		} else if (itemId == R.id.batch_archive_op) {
			onArchive(selection);
			return true;
		} else if (itemId == R.id.batch_spam_op) {
			onSpam(selection);
			return true;
		} else if (itemId == R.id.batch_move_op) {
			onMove(selection);
			return true;
    ...
    public boolean onContextItemSelected(MenuItem item) {
        ...
        if (item.getItemId() == R.id.open) {
		...
		} else if (item.getItemId() == R.id.deselect) {
			setSelected(selection, false);
		} else if (item.getItemId() == R.id.delete) {
			onDelete(selection);
		} else if (item.getItemId() == R.id.reply) {
			onReply(holder);
		} else if (item.getItemId() == R.id.reply_all) {
			onReplyAll(holder);
			...
			onCopy(selection);
		} else if (item.getItemId() == R.id.send_alternate) {
