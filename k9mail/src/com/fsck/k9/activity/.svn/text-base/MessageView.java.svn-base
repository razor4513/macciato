...
public class MessageView extends K9Activity implements OnClickListener {
    ...
    public void onClick(View view) {
        if (view.getId() == R.id.reply) {
			onReply();
		} else if (view.getId() == R.id.reply_all) {
			onReplyAll();
		} else if (view.getId() == R.id.delete) {
			onDelete();
		} else if (view.getId() == R.id.forward) {
			onForward();
		} else if (view.getId() == R.id.archive) {
			onRefile(mAccount.getArchiveFolderName());
		} else if (view.getId() == R.id.spam) {
			onRefile(mAccount.getSpamFolderName());
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if (item.getItemId() == R.id.delete) {
			...
			onCopy();
		} else if (item.getItemId() == R.id.show_full_header) {
			runOnUiThread(new Runnable() {
                @Override
                public void run() {
		...
		} else if (item.getItemId() == R.id.select_text) {
    ...
    protected Dialog onCreateDialog(final int id) {
        if (id == R.id.dialog_confirm_delete) {
		...
		} else if (id == R.id.dialog_attachment_progress) {
